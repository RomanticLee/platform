...
public enum DateStyle {
    ...
    YYYYMM("yyyyMM", false), YYYYMMDD("yyyyMMdd", false), YYYYMMDDHH("yyyyMMddHH", false),
    YYYYMMDDHHMM("yyyyMMddHHmm", false), YYYYMMDDHHMMSS("yyyyMMddHHmmss", false),

    YYMM("yyMM", false), YYMMDD("yyMMdd", false), YYMMDDHH("yyMMddHH", false),
    YYMMDDHHMM("yyMMddHHmm", false), YYMMDDHHMMSS("yyMMddHHmmss", false),
    YYMMDDHHMMSSMS("yyMMddHHmmssSSS", false),

    MMDD("MMdd", false), MMDDHH("MMddHH", false), MMDDHHMM("MMddHHmm", false), MMDDHHMMSS(
            "MMddHHmmss", false),

    HHMMSSSSS("HHmmssSSS", false),
