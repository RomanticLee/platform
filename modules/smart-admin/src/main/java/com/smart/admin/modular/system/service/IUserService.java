...
public interface IUserService extends IService<User> {
     ...
     * 根据条件查询用户列表
     */
    List<Map<String, Object>> selectUsers(DataScope dataScope, String name, String beginTime, String endTime, String deptid);
     ...
     * @return
     */
	List<Map<String, Object>> getAdminByRegion(String deptId);
